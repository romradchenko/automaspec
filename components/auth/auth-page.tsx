...
function SignInForm({ switchHref }: { switchHref: string }) {
            ...
            <CardContent className="space-y-4">
                ...
                <div className="text-center text-sm">
                    ...
                    <Button asChild variant="link" className="p-0 h-auto text-primary hover:underline">
                        <Link href={switchHref}>Sign up</Link>
                    </Button>
                </div>
            </CardContent>
        </Card>
...
function SignUpForm({ switchHref }: { switchHref: string }) {
    const [showPassword, setShowPassword] = useState(false)
    const router = useRouter()
        ...
        <div className="flex min-h-screen items-center justify-center bg-background p-4">
            <div className="w-full max-w-4xl flex flex-col md:flex-row gap-8 items-center justify-center">
                <div className="w-full max-w-md">
                    ...
                    {isSignUp ? <SignUpForm switchHref="/login" /> : <SignInForm switchHref="/signup" />}
                </div>
